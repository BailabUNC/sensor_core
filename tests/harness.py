...
from sensor_core.memory.stream_logger import BinaryStreamWriter, drain_ring, sealed_segments
...
class StoragePipeline:
    ...
    def ingest(self):
        ...
        ingest_pending_segments(self.stream_dir, self.sqlite_path, self.keys)
