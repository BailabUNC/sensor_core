...
class SensorManager(DataManager, StorageManager):
    def __init__(self,
        ...
        :param rotate_bytes: seal a stream segment before it grows past this many bytes (bounds segments of large
                             frames, such as images; each segment is stored in one transaction)
        ...
        try:
            self._setup(commport, baudrate, rotate_frames, rotate_seconds, rotate_bytes, **kwargs)
    ...
    def _setup(self, commport, baudrate, rotate_frames, rotate_seconds, rotate_bytes, **kwargs):
        ...
        if self.storage_enabled:
            ...
            self._stream_proc = Process(name="stream_writer", target=dump_loop,
                                        ...
                                        kwargs={"data_mode": self.data_mode,
                                                ...
                                                "rotate_bytes": int(rotate_bytes) if rotate_bytes else None})
