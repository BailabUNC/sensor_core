...
class StorageManager:
    ...
    def load_serial_channel(cls, key: str, filepath: str = './serial_db.sqlite3',
        ...
        if filetype == ".hdf5":
            ...
            """channel data is stoopid. try to find a way to append to channel without having intermediate array, can delete"""
    ...
    def append_serial_channel(self, key: str, data: np.ndarray):
        ...
        """
        """resize the channel using the hdf5 metadata and write direclty to it"""
